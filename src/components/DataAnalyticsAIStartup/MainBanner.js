            ...
            <div className="col-lg-5 col-md-12">
              <div className="banner-content">
                <h1
                  ...
                  data-aos-delay="100"
                >
                  BI como Serviço para Gestão da Saúde Pública no GDF.
                </h1>
                ...
                <p
                  ...
                  data-aos-delay="200"
                >
                  Objetivo é promover o uso gerencial da informação em serviços de saúde para a melhoria
                  da qualidade da atenção à saúde no Distrito Federal.
                </p>
